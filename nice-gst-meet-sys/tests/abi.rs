...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    ("PseudoTcpCallbacks", Layout {size: size_of::<PseudoTcpCallbacks>(), alignment: align_of::<PseudoTcpCallbacks>()}),
    ("PseudoTcpDebugLevel", Layout {size: size_of::<PseudoTcpDebugLevel>(), alignment: align_of::<PseudoTcpDebugLevel>()}),
    ("PseudoTcpShutdown", Layout {size: size_of::<PseudoTcpShutdown>(), alignment: align_of::<PseudoTcpShutdown>()}),
    ("PseudoTcpState", Layout {size: size_of::<PseudoTcpState>(), alignment: align_of::<PseudoTcpState>()}),
    ("PseudoTcpWriteResult", Layout {size: size_of::<PseudoTcpWriteResult>(), alignment: align_of::<PseudoTcpWriteResult>()}),
];

const RUST_CONSTANTS: &[(&str, &str)] = &[
    ("NICE_AGENT_MAX_REMOTE_CANDIDATES", "25"),
    ("(guint) NICE_AGENT_OPTION_BYTESTREAM_TCP", "64"),
    ("(guint) NICE_AGENT_OPTION_CONSENT_FRESHNESS", "32"),
    ("(guint) NICE_AGENT_OPTION_ICE_TRICKLE", "8"),
    ("(guint) NICE_AGENT_OPTION_LITE_MODE", "4"),
    ("(guint) NICE_AGENT_OPTION_NONE", "0"),
