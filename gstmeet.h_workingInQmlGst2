...
Connection *gstmeet_connection_new(struct Context *context,
                                   const char *websocket_url,
                                   const char *xmpp_domain,
                                   const char *room_name,
                                   bool tls_insecure);

void gstmeet_connection_free(Connection *connection);

bool gstmeet_connection_connect(struct Context *context, Connection *connection);
...
void gstmeet_conference_on_participant(struct Context *context,
                                       JitsiConference *conference,
                                       GstBin *(*f)(JitsiConference*, struct Participant, void*),
                                       void *ctx);
